...
class CircleAnimation {
    ...
    createDogs() {
        ...
        for (let i = 0; i < this.NRPTS; i++) {
            ...
            this.lastPositions.push({x: dog.x, y: dog.y, dx: dog.dx, dy: dog.dy, speed: dog.speed}); // saves its initial position in this.lastPositions
        }
    ...
    resetAnimation() {
        this.dogs.forEach((d, index) => {
            ...
            d.speed = this.lastPositions[index].speed;
            d.steps = 0;
    ...
    updateLastPositions() {
        this.dogs.forEach((d, index) => {
            this.lastPositions[index] = { x: d.x, y: d.y, dx: d.dx, dy: d.dy, speed: d.speed};
        });
    }
